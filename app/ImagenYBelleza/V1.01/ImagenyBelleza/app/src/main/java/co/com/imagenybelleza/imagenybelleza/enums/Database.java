...
public class Database {
    ...
    public static final String KEY_PRICE_ONE = "price_one";
    public static final String KEY_PRICE_TWO = "price_two";
    public static final String KEY_PRICE_THREE = "price_three";
    public static final String KEY_PRICE_FOUR = "price_four";
    public static final String KEY_PRICE_FIVE = "price_five";
    ...
    public static String CREATE_ITEM = "CREATE TABLE " + TABLE_ITEM + " (" + KEY_ID + " INTEGER NOT NULL, "
            ...
            + KEY_BRAND_ID + " INTEGER NOT NULL, " + KEY_CATEGORY_ID + " INTEGER NOT NULL, "
            + KEY_SUBITEM_ID + " INTEGER NOT NULL, " + KEY_PRICE_ONE + " DOUBLE NOT NULL, "
            + KEY_PRICE_TWO + " DOUBLE NOT NULL, " + KEY_PRICE_THREE + " DOUBLE NOT NULL, " + KEY_PRICE_FOUR + " DOUBLE NOT NULL, "
            + KEY_PRICE_FIVE + " DOUBLE NOT NULL, " + KEY_PAYMENT_ONE + " DOUBLE NOT NULL, " + KEY_PAYMENT_TWO + " DOUBLE NOT NULL, "
