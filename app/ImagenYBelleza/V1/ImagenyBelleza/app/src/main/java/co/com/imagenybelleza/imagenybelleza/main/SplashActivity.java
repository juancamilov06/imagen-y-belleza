            ...
            try {
                ...
                if (itemsResponse.length() > 0) {
                    ...
                    for (int i = 0; i < itemsResponse.length(); i++) {
                        ...
                        item.setDiscountOne(itemObject.getDouble("discount_one"));
                        item.setDiscountTwo(itemObject.getDouble("discount_two"));
                        item.setDiscountThree(itemObject.getDouble("discount_three"));
                        item.setDiscountFour(itemObject.getDouble("discount_four"));
                        item.setDiscountFive(itemObject.getDouble("discount_five"));
