            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="input-field">
                            <input name="units" id="units" type="number" placeholder="0" class="black-text">
                            <label for="units">Unidades</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-field">
                            <input name="concept" id="concept" type="text" placeholder="Concepto de la salida"
                                   class="black-text">
                ...
                <div class="row text-center">
                    <a class="waves-effect waves-light btn white-text" name="btn-login" type="submit" id="btn-login"
                       onClick="sendData()">CREAR SALIDA</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/js/item_disposal.js'); ?>"></script>
