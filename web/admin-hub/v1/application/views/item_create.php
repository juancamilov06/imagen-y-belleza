...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="/admin-hub/main">
                    Pedidos
                </a>
            </li>
            <li>
                <a href="/admin-hub/clients">
                    Clientes
                </a>
            </li>
            <li>
                <a href="/admin-hub/brands">
                    Marcas
                </a>
            </li>
            <li>
                <a href="/admin-hub/categories">
                    Categorias
                </a>
            </li>
            <li>
                <a href="/admin-hub/inventory">
                    Inventario
                </a>
            </li>
            <li>
                <a href="/admin-hub/users">
                    Usuarios
                </a>
            </li>
            <li>
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="input-field">
                            <input name="price" id="price" type="number" class="black-text">
                ...
                <div class="col-md-12">
                    <div class="col-md-6 col-sm-6">
                        <div class="input-field">
                            ...
                            <label for="dis-1">Pronto pago 0 dias</label>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="input-field">
                            <input name="dis-2" id="dis-2" type="number" value="0">
                            <label for="dis-2">Pronto pago 8 dias</label>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="input-field">
                            <input name="dis-3" id="dis-3" type="number" value="0">
                            <label for="dis-3">Pronto pago 15 dias</label>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="input-field">
                            <input name="dis-4" id="dis-4" type="number" value="0">
                            <label for="dis-4">Pronto pago 30 dias</label>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                        <div class="input-field">
                            <input name="dis-5" id="dis-5" type="number" value="0">
                            <label for="dis-5">Pronto pago 30 dias</label>
                        </div>
                    </div>
                </div>
